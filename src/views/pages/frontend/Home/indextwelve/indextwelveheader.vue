<template>
  ...
  <div class="header-top home-three-top">
    <div class="left-top aos" data-aos="fade-up">
      <ul>
        <li><i class="feather-phone me-1"></i> +92 324 4757212</li>
      ...
      <nav class="navbar navbar-expand-lg header-nav nav-transparent">
        ...
        <div class="main-menu-wrapper">
          ...
          <ul class="main-nav black-font">
            <li class="has-submenu" :class="homeMenu ? 'active' : 'notactive'">
              ...
              <ul class="submenu">
                ...
                <li
                  :class="
                    currentPath == 'index-twelve' ? 'active' : 'notactive'
                  "
                >
                  <router-link to="/index-twelve">Home 12</router-link>
                </li>
            ...
            <li class="has-submenu">
              ...
              <ul class="submenu">
                ...
                <li>
                  <router-link to="/booking-success"
            ...
            <li class="has-submenu">
              ...
              <ul class="submenu">
                ...
                <li><router-link to="/search">Search Doctors</router-link></li>
          ...
          <ul class="nav header-navbar-rht right-menu">
            <li class="nav-item">
              <router-link class="nav-link login-blue-bg btn-one" to="/login">
                <i class="feather-user me-1"></i> Sign In
              </router-link>
            </li>
            <li class="nav-item">
              <router-link
                class="nav-link signup-white-bg btn-one"
                to="/register"
              >
...
export default {
  ...
  computed: {
    ...
    homeMenu() {
      return (
        this.$route.name == "index-twelve" ||
        this.$route.name == "index-fourteen" ||

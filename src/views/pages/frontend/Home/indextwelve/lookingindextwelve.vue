					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="looking-box w-100 hvr-bounce-to-bottom">
							...
							<div class="looking-info">
								<router-link to="/search" class="looking-link">Visit a Doctor</router-link>
								<p>We hire the best specialists to deliver top-notch diagnostic services for you.</p>
							</div>
							<div class="looking-btn">
								<router-link to="/booking" class="btn btn-one w-100"><span>Book Now</span></router-link>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="looking-box w-100 hvr-bounce-to-bottom">
							...
							<div class="looking-info">
								<router-link to="/pharmacy-search" class="looking-link">Find a Pharmacy</router-link>
								<p>We provide the a wide range of medical services, so every person could have the opportunity.</p>
							</div>
							<div class="looking-btn">
								<router-link to="/booking" class="btn btn-one w-100"><span>Find Now</span></router-link>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="looking-box w-100 hvr-bounce-to-bottom">
							...
							<div class="looking-info">
								<a href="javascript:void(0);" class="looking-link">Find a Lab</a>

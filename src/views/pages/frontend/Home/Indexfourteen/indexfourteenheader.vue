      ...
      <div class="nav-bg-five">
        <nav class="navbar navbar-expand-lg header-nav nav-transparent">
            ...
            <ul class="main-nav black-font">
              <li class="has-submenu active">
                ...
                <ul class="submenu">
                  ...
                  <li>
                    <router-link to="/index-thirteen">Home 13</router-link>
                  </li>
                  <li class="active">
                    <router-link to="/index-fourteen">Home 14</router-link>
                  </li>
                </ul>
              </li>
          ...
          <ul class="nav header-navbar-rht">
            ...
            <li class="nav-item">
              <router-link class="nav-link btn-five" to="/login"
                >Sign In</router-link
              >
            </li>
            <li class="nav-item">
              <router-link class="nav-link btn-five-light" to="/register"
                >Sign Up</router-link
              >
            </li>
          </ul>

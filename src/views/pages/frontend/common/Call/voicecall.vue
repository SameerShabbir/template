									...
									<div class="call-window">
											...
											<div class="navbar">
												<div class="user-details me-auto">
													<div class="float-start user-img">
														<router-link class="avatar avatar-sm me-2" to="/patient-profile" title="Charlene Reed">
										...
										<div class="call-footer">
											<div class="call-icons">
												<ul class="call-items">
													<li class="call-item">
														<a href="javascript:void(0);" class="me-1" title="Enable Video" data-placement="top" data-bs-toggle="tooltip">
													...
													<li class="call-item ms-1">
														<a href="javascript:void(0);" class="me-1" title="Add User" data-placement="top" data-bs-toggle="tooltip">

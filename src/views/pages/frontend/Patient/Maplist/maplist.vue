						...
						<div class="row align-items-center mb-4">
							...
							<div class="col-md-6 col-auto">
								<div class="view-icons">
									<router-link to="/map-grid" class="grid-view"><i class="fas fa-th-large"></i></router-link>
									<router-link to="/map-list" class="list-view active"><i class="fas fa-bars"></i></router-link>
								</div>
								...
								<div class="doctor-widget">
									<div class="doc-info-left">
										...
										<div class="doc-info-cont">
											<h4 class="doc-name"><router-link to="/doctor-profile">Dr. Ruby Perrin</router-link></h4>
							...
							<div class="card-body">
								<div class="doctor-widget">
									<div class="doc-info-left">
										...
										<div class="doc-info-cont">
											<h4 class="doc-name"><router-link to="/doctor-profile">Dr. Darren Elder</router-link></h4>
							...
							<div class="card-body">
								<div class="doctor-widget">
									<div class="doc-info-left">
										...
										<div class="doc-info-cont">
											<h4 class="doc-name"><router-link to="/doctor-profile">Dr. Deborah Angel</router-link></h4>
							...
							<div class="card-body">
								<div class="doctor-widget">
									<div class="doc-info-left">
										...
										<div class="doc-info-cont">
											<h4 class="doc-name"><router-link to="/doctor-profile">Dr. Sofia Brient</router-link></h4>
							...
							<div class="card-body">
								<div class="doctor-widget">
									<div class="doc-info-left">
										...
										<div class="doc-info-cont">
											<h4 class="doc-name"><router-link to="/doctor-profile">Dr. Katharine Berthold</router-link></h4>

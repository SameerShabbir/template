                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-6 col-auto">
                            <div class="view-icons ">
                                <router-link to="/map-grid" class="grid-view active"><i class="fas fa-th-large"></i></router-link>
                                <router-link to="/map-list" class="list-view"><i class="fas fa-bars"></i></router-link>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Ruby Perrin</router-link> 
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Deborah Angel</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Sofia Brient</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Marvin Campbell</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Katharine Berthold</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Linda Tobin</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Paul Richard</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. John Gibbs</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                                        <p class="speciality">MDS - Periodontology and Oral Implantology, BDS</p>
                                        <div class="rating mapgridrating">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Olga Barlow</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                                        <p class="speciality">MDS - Periodontology and Oral Implantology, BDS</p>
                                        <div class="rating mapgridrating">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Julia Washington</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-6">
                                <div class="profile-widget">
                                    ...
                                    <div class="pro-content">
                                        <h3 class="title">
                                            <router-link to="/doctor-profile">Dr. Shaun Aponte</router-link> 
                                            <i class="fas fa-check-circle verified"></i>
                                        </h3>

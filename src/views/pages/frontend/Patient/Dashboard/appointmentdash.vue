                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-center mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr v-for="item in appointmentdash" :key="item.id">
                                                                <td>
                                                                    <h2 class="table-avatar">
                                                                        ...
                                                                        <router-link to="/doctor-profile">{{item.name}} <span>{{item.specialist}}</span></router-link>
                                                                    </h2>
                                                                </td>
                                                                ...
                                                                <td>{{item.rate}}</td>
                                                                <td>{{item.date2}}</td>
                                                                <td><span class="badge rounded-pill bg-success-light">{{item.status}}</span></td>
                                                                <td class="text-end">
...
<script>
    import appointmentdash from '../../../../../assets/json/Patient/appointmentdash.json'

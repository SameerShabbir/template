            ...
            <div class="dashboard-widget">
                <nav class="dashboard-menu">
                    <ul>
                        ...
                        <li :class="currentPath == 'patient-accounts' ? 'active' : 'notaactive'">
                        ...
                        <li :class="currentPath == 'profile-settings' ? 'active' : 'notaactive'">
                            <router-link to="/profile-settings">
                                <i class="fas fa-user-cog"></i>
                                <span>Profile Settings</span>
                            </router-link>
                        </li>
                        <li :class="currentPath == 'change-password' ? 'active' : 'notaactive'">

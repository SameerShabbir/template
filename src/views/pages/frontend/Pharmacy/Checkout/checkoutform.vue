...
<!-- Checkout Form -->
									<form>
										...
										<div class="info-widget">
											...
											<div class="exist-customer">Existing Customer? <a href="javascript:void(0);">Click here to login</a></div>
										</div>
										<!-- /Personal Information -->
										...
										<div class="payment-widget">
											...
											<div class="terms-accept">
												<div class="custom-checkbox">
												   ...
												   <label for="terms_accept1">I have read and accept <a href="javascript:void(0);">Terms &amp; Conditions</a></label>
												</div>
											</div>
											<!-- /Terms Accept -->
                                            ...
                                            <router-link to="/payment-success">

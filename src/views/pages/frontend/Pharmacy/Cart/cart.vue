										...
										<tr v-for="item in cart" :key="item.id">
											<td>
												<h2 class="table-avatar">
													<router-link to="/product-description" class="avatar avatar-sm me-2"><img class="avatar-img" :src="loadImg(item.img)" alt="User Image"></router-link>
												</h2>
												<router-link to="/product-description">{{item.name}}</router-link>
											</td>
											<td>{{item.rate}}</td>
											<td>{{item.price}}</td>					
									...
									<div class="booking-summary">
										<div class="booking-item-wrap">
											<ul class="booking-date">
												...
												<li>Shipping <span>$25.00<a href="javascript:void(0);">Calculate shipping</a></span></li>
											</ul>
												...
												<ul class="booking-total-list">
													...
													<li>
														<div class="clinic-booking pt-4">
															<router-link class="apt-btn" to="/product-checkout">Proceed to checkout</router-link>
														</div>
													</li>
												</ul>
											</div>

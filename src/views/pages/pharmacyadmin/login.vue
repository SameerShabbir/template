            ...
            <div class="login-wrapper">
                <div class="loginbox">
                    ...
                    <Form class="login" @submit="onSubmit" :validation-schema="schema" v-slot="{ errors }">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <router-link class="forgot-link" to="/pharmacyadmin/forgot-password">Forgot Password ?</router-link>
                                </div>
                            </div>
                        </div>
                        <div class="d-grid">
                        ...
                        <div class="dont-have">Don't have an account? <router-link to="/pharmacyadmin/register">Sign up</router-link></div>
                        <div class="login-or">

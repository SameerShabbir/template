                ...
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-sm-5 col">
                            <a href="#Add_Specialities_details" data-bs-toggle="modal" class="btn btn-primary float-end d-flex justify-content-between align-items-center"><i class="feather-plus-square me-1"></i> Add New</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                        ...
                        <div class="card">
                                    ...
                                    <div class="col-auto custom-list d-flex">
                                        ...
                                        <div class="SortBy">
                                            <div class="selectBoxes order-by">
                                                <p class="mb-0"><img src="../../../assets/pharmacy_img/icon/sort.png" class="me-2" alt="icon"> Order by </p>
                                            ...
                                            <div id="checkBox">
                                                <form>
                                                    ...
                                                    <router-link to="/pharmacyadmin/product-category">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="datatable table table-borderless hover-table" id="categories">
...
<script>
    import categories from '../../../assets/json/pharmacyadmin/categories.json';

                ...
                <div class="page-header">
                    <div class="row d-flex justify-content-between align-items-center">
                        <div class="col-sm-7 col-auto">
                            <h3 class="page-title mb-0">Purchase</h3>
                        </div>
                        <div class="col-sm-5 col">
                            <router-link to="/pharmacyadmin/add-purchase" class="btn btn-primary float-end d-flex justify-content-between align-items-center">
                                <i class="feather-plus-square me-1"></i> Add New</router-link>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="datatable table table-borderless hover-table" id="purchase">
                                        ...
                                        <tbody>
                                            <tr v-for="item in purchase" :key="item.id">
                                                ...
                                                <td class="text-end">
                                                    <div class="actions">
                                                        <router-link to="/pharmacyadmin/edit-purchase" class="text-black">
...
<script>
    import purchase from '../../../../assets/json/pharmacyadmin/purchase.json';

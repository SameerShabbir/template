                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="datatable table table-borderless hover-table" id="products">
...
<script>
    import products from '../../../../assets/json/pharmacyadmin/products.json';

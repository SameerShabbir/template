<template>
                    ...
                    <div class="card">
                        <div class="card-header border-bottom-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h5 class="card-title">Outstock List</h5>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="datatable table table-borderless hover-table" id="outstock">
                                    ...
                                    <tbody>
                                        <tr v-for="item in outstock" :key="item.id">
                                            ...
                                            <td>{{item.user1}}</td>
                                            <td>{{item.rate}}</td>
                                            <td><span class="btn btn-sm bg-danger-light">{{item.span}}</span></td>
                                            <td>{{item.amount}}</td>
                                            <td><span class="btn btn-sm bg-danger-light">{{item.span1}}</span></td>
                                            <td class="text-end">
                                                <div class="actions">
    ...
    <div class="modal fade" id="edit_specialities_details" aria-hidden="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document" >
            <div class="modal-content doctor-profile">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Expired</h5>
                    <button type="button" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><i class="feather-x-circle"></i></button>
                </div>
                <div class="modal-body">
                    <form>
...
<script>
    import outstock from '../../../../assets/json/pharmacyadmin/outstock.json';

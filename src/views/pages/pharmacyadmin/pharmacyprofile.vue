								...
								<div class="profile-list">
									<div class="profile-detail">
										<label class="avatar profile-cover-avatar">
											<img class="avatar-img" src="../../../assets/pharmacy_img/profiles/avatar-02.jpg" alt="Profile Image">
										</label>
										<div class="pro-name">
											<p>@ Johnson223</p>
											<h4>Johnson Samuel</h4>
										</div>
										<a href="javascript:void(0);" class="edit-pro"><i class="feather-edit"></i> Edit</a>
									</div>
									<div class="row">
										<div class="col-md-12">

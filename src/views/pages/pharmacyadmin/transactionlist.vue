          ...
          <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title mb-0">Transactions</h3>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <table class="datatable table table-borderless hover-table" id="transactionlist">
                                        ...
                                        <tbody>
                                            <tr v-for="item in transactionlist" :key="item.id">
                                                <td><router-link to="/pharmacyadmin/invoice">{{item.no}}</router-link></td>
                                                <td>{{item.no1}}</td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge rounded-pill bg-success inv-badge">{{item.status}}</span>
                                                </td>
                                                <td class="text-end">
                                                    <div class="actions">
...
<script>
    import transactionlist from '../../../assets/json/pharmacyadmin/transactionlist.json';
    ...
    export default {
        ...
        mounted() {
        util.datatable('#transactionlist')
        },
        methods: {
            loadImg(imgPath) {

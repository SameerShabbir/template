							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="upload-file">
										...
										<div class="up-img">
											<img class="avatar avatar-img" src="../../../../assets/admin_img/profiles/avatar-05.jpg" alt="User Image">
...
<script>
	...
	export default {
	  data() {
	  return {
		category: ["Category", "Dermotology", "Neurology"],
		type: ["Blog Type", "Standard Blog", "Video Blog"]
	  }
	  },
	  components: {
